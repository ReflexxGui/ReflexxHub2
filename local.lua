...
local Tab2Section = Tab2:NewSection("Made By Reflexx")
local Tab2Section = Tab2:NewSection("YouTube | ReflexxGui")
local Tab2Section = Tab2:NewSection("Discord | reflexx#0001")
local Tab2Section = Tab2:NewSection("Discord Server | https://discord.gg/swkNUEAz2a")
local Tab2 = window:NewTab("Updates")
local Tab2Section = Tab2:NewSection("Reflexx Hub")
...
--//fsddfsdf
notif("Loaded successfully! Created by reflexx#0001", 5)
end)
